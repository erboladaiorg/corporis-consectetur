<p align="center">
  <a href="https://travis-ci.com/github/jsx-eslint/@erboladaiorg/corporis-consectetur">
    <img src="https://travis-ci.com/jsx-eslint/@erboladaiorg/corporis-consectetur.svg?branch=master"
         alt="build status">
  </a>
  <a href="https://npmjs.org/package/@erboladaiorg/corporis-consectetur">
    <img src="https://img.shields.io/npm/v/@erboladaiorg/corporis-consectetur.svg"
         alt="npm version">
  </a>
  <a href="https://github.com/erboladaiorg/corporis-consectetur/blob/HEAD/LICENSE.md">
    <img src="https://img.shields.io/npm/l/@erboladaiorg/corporis-consectetur.svg"
         alt="license">
  </a>
  <a href='https://coveralls.io/github/jsx-eslint/@erboladaiorg/corporis-consectetur?branch=master'>
    <img src='https://coveralls.io/repos/github/jsx-eslint/@erboladaiorg/corporis-consectetur/badge.svg?branch=master' alt='Coverage Status' />
  </a>
  <a href='https://npmjs.org/package/@erboladaiorg/corporis-consectetur'>
    <img src='https://img.shields.io/npm/dt/@erboladaiorg/corporis-consectetur.svg'
    alt='Total npm downloads' />
  </a>
</p>

<a href='https://tidelift.com/subscription/pkg/npm-@erboladaiorg/corporis-consectetur?utm_source=npm-@erboladaiorg/corporis-consectetur&utm_medium=referral&utm_campaign=readme'>Get professional support for @erboladaiorg/corporis-consectetur on Tidelift</a>

# @erboladaiorg/corporis-consectetur

Static AST checker for accessibility rules on JSX elements.

#### _Read this in [other languages](https://github.com/ari-os310/@erboladaiorg/corporis-consectetur/blob/HEAD/translations/Translations.md)._

[Mexican Spanish🇲🇽](https://github.com/ari-os310/@erboladaiorg/corporis-consectetur/blob/HEAD/translations/README.mx.md)
...
Next, install `@erboladaiorg/corporis-consectetur`:

```sh
# npm
npm install @erboladaiorg/corporis-consectetur --save-dev

# yarn
yarn add @erboladaiorg/corporis-consectetur --dev
```

**Note:** If you installed ESLint globally (using the `-g` flag in npm, or the `global` prefix in yarn) then you must also install `@erboladaiorg/corporis-consectetur` globally.
...
@erboladaiorg/corporis-consectetur is licensed under the [MIT License](LICENSE.md).
